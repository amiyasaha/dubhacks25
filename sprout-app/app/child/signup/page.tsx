      ...
      <main className="relative z-10 container mx-auto px-6 py-12 flex items-center justify-center min-h-[calc(100vh-120px)]">
        <div className="w-full max-w-md">
          <div className="text-center mb-8">
            ...
            <h2 className="text-3xl font-bold text-sprout-green mb-2">Child</h2>
            <p className="text-sprout-green">Log In</p>
          </div>
          ...
          <Card className="p-8 shadow-xl">
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-muted-foreground">
                Need help? Ask your guardian to create an account for you.
              </p>
            </div>
          </Card>
        </div>
